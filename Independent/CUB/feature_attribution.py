...
def main(args):
    classes_name = pd.read_csv("../CUB/CUB_200_2011/CUB_200_2011/classes.txt", sep="\s+", header=None, names=["Index", "Name"])
    concepts_name = pd.read_csv("../CUB/CUB_200_2011/attributes_filtered.txt", sep="\s+", header=None, names=["Index", "Name"])
